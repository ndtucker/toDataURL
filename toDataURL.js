...
(function ()
{
    ...
    /**
     * CRC table of all 8-bit messages.
     * @type {Number[]}
     */
    var CRC_TABLE             = [
     ...
     * @type {Number}
     */
    var BLOCK_SIZE            = 0x00008000;


    /**
     * Convert signed interger (Number) to unsigned integer.
     * @return {Number}
     */
    ...
    function toDataURL(type)
    {
        ...
        ImageStream.concat(
            ...
            width.bytes32(),          // 4 bit width
            height.bytes32(),         // 4 bit height
            BIT_DEPTH,                // bit depth
        ...
        // Concatenate crc32 checksum for IHDR chunk
        ImageStream.concat(ImageStream.crc32(12, 17).bytes32());
        ...
        ImageStream.push((ImageData.length + 5 * blocks + 6).bytes32());


        var crcStart    = ImageStream.length;
        var crcLength   = ImageData.length;
        ...
        ImageStream.concat(
            ImageData.adler32().bytes32(),
            ImageStream.crc32(crcStart, crcLength).bytes32(),
            0x00, 0x00, 0x00, 0x00,
            0x49, 0x45, 0x4e, 0x44  // END
        );


        // Checksum the END
        ImageStream.concat(ImageStream.crc32(ImageStream.length - 4, 4));
